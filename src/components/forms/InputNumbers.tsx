...
export interface IFormsInputNumbers {
    label?: string;
    placeholder:string;
    propertyName:string;
    disabled?:boolean;
...
const InputNumbers = ({
  ...
  const classes = responsive ? "md:flex"+margin : margin;
    ...
    const onNumbersKeyPress = (event:any) => {
        debugger
    ...
    return (
        <div className={classes}>
            ...
            <div className={classInput}>
              ...
              onKeyPress={e=>onNumbersKeyPress(e)} 
              onChange={e=>onNumbersChange(e)}/>
            </div>
...
export const FormInputNumbers =  React.forwardRef(InputNumbers);